...
function projectModel(Component,ProjectNmae) {
	...
	pieChar(priority,"Priority","http://qa.aiqidi.com:7108/"+ProjectNmae+"/Priority"); //(Component,CaptionNmae,Link)
	/** Show Pie chart  **/
	var status = new ChartComponent();
	Component.addComponent (status);
	pieChar(status,"Status","http://qa.aiqidi.com:7108/"+ProjectNmae+"/Resolution"); //(Component,CaptionNmae,Link)
	/** Show Pie chart  **/
	var resolution = new ChartComponent();
	Component.addComponent (resolution);
	pieChar(resolution,"Resolution","http://qa.aiqidi.com:7108/"+ProjectNmae+"/Status"); //(Component,CaptionNmae,Link)
  ...
  //   	var issue_status_APP = new ChartComponent();
		...
		// stackedColumnChar(issue_status_APP,"Issue_status_APP","http://qa.aiqidi.com:7108/"+ProjectNmae+"/DiffVersionAPP");

		// var issue_status_WEB = new ChartComponent();
		// Component.addComponent (issue_status_WEB);
		// issue_status_WEB.setDimensions (6, 4);
		// stackedColumnChar(issue_status_WEB,"Issue_status_WEB","http://qa.aiqidi.com:7108/"+ProjectNmae+"/DiffVersionWEB");
   
   		var so_far_status_APP = new ChartComponent();
    	so_far_status_APP.setDimensions (12, 4);
		Component.addComponent (so_far_status_APP);
		stackedColumnChar(so_far_status_APP,"JIRA issue status in diff. versions_APP","http://qa.aiqidi.com:7108/"+ProjectNmae+"/DiffVersionSoFarAPP");

		var so_far_status_WEB = new ChartComponent();
    	so_far_status_WEB.setDimensions (12, 4);
		Component.addComponent (so_far_status_WEB);
		stackedColumnChar(so_far_status_WEB,"JIRA issue status in diff. versions_WEB","http://qa.aiqidi.com:7108/"+ProjectNmae+"/DiffVersionSoFarWEB");

		/** Show Line chart  **/
	    var daily_status = new ChartComponent();
		Component.addComponent (daily_status);
		LineChar("TYGH",daily_status,"JIRA issue remain by time(Daily)","http://qa.aiqidi.com:7108/"+ProjectNmae+"/TYGHDiffDate");
  ...
  //   	issue_status.setDimensions (6, 4);
		...
		// stackedColumnChar(issue_status,"Issue_status","http://qa.aiqidi.com:7108/"+ProjectNmae+"/DiffVersion");

		var so_far_status = new ChartComponent();
    	so_far_status.setDimensions (12, 4);
		Component.addComponent (so_far_status);
		stackedColumnChar(so_far_status,"JIRA issue status in diff. versions","http://qa.aiqidi.com:7108/"+ProjectNmae+"/DiffVersionSoFar");
    
		/** Show Line chart  **/
	    var daily_status = new ChartComponent();
		Component.addComponent (daily_status);
		LineChar("BABY",daily_status,"JIRA issue remain by time(Daily)","http://qa.aiqidi.com:7108/"+ProjectNmae+"/DiffDate");
    }
	var table = new TableComponent();
	Component.addComponent (table);
	TableChar(table,"Resolution","http://qa.aiqidi.com:7108/"+ProjectNmae+"/IssueTimeSpent"); //(Component,CaptionNmae,Link)
...
function TableChar(Component,CaptionName,AddrLink) {
    ...
    Component.addColumn ("key", "Key");
    Component.addColumn ("summary", "Summary");
	...
	// LineChar(weekly_status,"Version_status(Weekly)","http://qa.aiqidi.com:7108/"+ProjectNmae+"/WeekRemain");
//}
...
function stackedColumnChar(Component,CaptionName,AddrLink) {
	...
	$.get(AddrLink, function (data) {
	// $.get("http://qa.aiqidi.com:7108/lookup/BABY", function (data) {
		Component.setLabels (data['Name']); // You can also use data.categories
